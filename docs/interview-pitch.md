...
| 指标 / 态势 | Operator `:18081/metrics`；Grafana Dashboard **AI Platform Healing**（[observability.md](./observability.md)） |
...
./scripts/observability-stack.sh up       # Grafana :3000（与 demo 并行）
```
